...
def one_module(module):
    """
    Set the parameters of a module to one and return it.
    """
    assert module.kernel_size == (1, 1) and module.in_channels == module.out_channels
    nn.init.zeros_(module.bias)
    module.weight.data.copy_(torch.eye(module.in_channels)[..., None, None])
    return module
